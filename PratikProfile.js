    ...
    <div>
        <div className="ctQZg">   
            <div className="_47KiJ">
                ...
                <p style={{marginRight : 5000, marginTop :40}}>pratik08_ </p>
                <hr />        
            </div>
        </div>
        ...
        <div className="ctQZg">   
            <div className="_47KiJ">
                <img src={DpPratik} height="140" width="140" style={{borderRadius : 70, marginTop :200, marginLeft : 1000}}></img>
                <p style={{marginLeft :100, marginTop : 200, fontSize : 50}}>2</p>

                <p style={{ marginTop : 300, marginLeft : -35}}>Posts</p>
                
                <p style={{marginLeft :90, marginTop : 200, fontSize : 50}}>831</p>
                
                <p style={{marginTop : 300, marginLeft : -80}}>Followers</p>
                
                <p style={{marginLeft :80, marginTop : 200, fontSize : 50}}>670</p>
        ...
        <div className="ctQZg">   
            <div className="_47KiJ">
                <p style={{marginTop : 360, marginLeft : 1010, fontWeight : 700}}> pratik08_</p>
                </div>
            </div>
        ...
        <div className="ctQZg">   
            <div className="_47KiJ">
                <p style={{marginTop : 400, marginLeft : 1010, fontWeight : 700}}> <pre>Karma </pre></p>
            ...
            <div className="ctQZg">   
            <div className="_47KiJ">
                <img src={Pratik1} style={{marginTop : 550, marginLeft : 1010, fontWeight : 700, blockSize : 200}}></img>
                <img src={Pratik2} style={{marginTop : 550, marginLeft : 10, fontWeight : 700, blockSize : 200}}></img>
